...
latex_documents = [
    (master_doc, 'DIA.tex', 'DIA Documentation',
...
man_pages = [
    (master_doc, 'decentralizedinformationaccess', 'DIA Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'DIA', 'DIA Documentation',
